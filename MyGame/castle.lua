...
免除广告 12
随机卡片 12
闪烁    30 （暂不实现）移动的同时，另一只手在下半屏幕向上下左右四个方向滑动，则可以瞬移到这个方向一定距离，可以跨越障碍，可能会破坏游戏平衡，建议谨慎购买，可以用于通过二周目
...
第二周目：你保留记忆又回到了开始，你会保留卡片，
    由于你已经获得了二段跳，就会法师后，法师会给你头饰，可获得更多的无敌时间，可用于过二周目（如果不断刷的话）和获得超级跳；
    工厂作战会失败，但你已经知道了碎片在赛博空间也知道密码；
    去图书馆前，法师会告诉你里面有增加飞行能力的卡片，于是在图书馆有个特殊的空间，完成任务后得到超级跳（就是向下蓄力后跳起，能比以前高很多，这是二周目关键，空中也可以）
