...
你第一次清理掉一个场景后，会提示出现隐藏宝箱，以后只有提示音。
...
第一周目：击败最终boss后，boss会透露认识主角的感觉，并且并没有想到主角能够击败他，所以他不得不使用那个技能，尽管知道主角有一定的免疫力，
    ...
    主角会保留卡片，会获取到一件新装备：头饰；

第二周目：boss会说竟然又被你击败，好在那招还好用，如果你在二周目会得到某种技能（比如冲刺过程中不会击退，或者别的什么，再想）
    可以在loading技能成功前击中boss，直接渐黑进入结束动画：会告诉你人类在你的帮助下击败了恶魔取得了胜利，而你也会被后人传颂；
    然后又回到了场景中，你可以出发boss尸体，选择是否loading进入第三周目；
    主角会获得一个背包格子

第三周目：boss会说竟然又被你击败，好在那招还好用，如果这次你能击中boss，boss会消失，从另一边出来了真正的boss，原来你击中的那个是替身，
