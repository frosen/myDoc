...
第一次落水，可水上行走0.5s
每物理攻击命中一个怪物，恢复10点能量；能量可给下一次命中的魔法进行增幅，75%概率伤害为300%，不同魔法消耗不一样；最多300点；以颜色显示而不是以数值 (1)
每物理攻击命中一个可破坏物，恢复10点能量 (2)
切换地图区域时，如果能量不足100，则补足到100
...
跟随小飞机 直线炮向前后最近的敌人发射子弹
实力的证明 减少攻击力40%，受到伤害增加40%，此状态下消灭boss可以获得额外的UI效果，比如剑的颜色，用户界面的颜色等
